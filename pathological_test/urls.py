...
from pathological_test.views import PathologicalTestViewSet, PathologicalTestDetailsViewSet, ShopingCartViewSet, GetShopingCartViewSet, OrderDetailViewSet, UserOrderViewSet, PhlebotomistsViewSet
