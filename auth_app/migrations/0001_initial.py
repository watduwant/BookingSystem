    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('cr', 'customer'), ('so', 'shopowner')], max_length=20)),
                ('city', models.CharField(blank=True, max_length=50)),
                ('address', models.CharField(default='NULL', max_length=200)),
                ('flat_name', models.CharField(default='NULL', max_length=200)),
                ('landmark', models.CharField(default='NULL', max_length=200)),
